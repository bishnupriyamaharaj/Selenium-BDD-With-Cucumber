...
public class RescheduledCancelbookingjob {
    public WebDriver driver=null;

    @Given("Open browser and Login with individual Buyer for Reschedule and cancel booking job")
    public void openBrowserAndLoginWithIndividualBuyerForRescheduleAndCancelBookingJob() {
    ...
    public void clickTheServiceDropdownAndBookABookinglistJobForSeller() throws InterruptedException {
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath("//input[@id='ratedate']")).sendKeys("25.08.2022");
        driver.findElement(By.xpath("//input[@id='ratetime']")).sendKeys("13:10");
    ...
    public void logoutFromBuyerAndLoginAsSellerToAcceptTheRescheduleBookingJob()  throws InterruptedException {
    ...
    public void logoutFromSellerAndLoginAsBuyerToAwardTheRescheduleBookingJob() throws InterruptedException {
        Actions action = new Actions(driver);
...
//        driver.findElement(By.xpath("/html[1]/body[1]/div[9]/div[1]/div[1]/div[2]/div[1]/form[1]/div[1]/div[7]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]")).click();
       ...
       driver.findElement(By.xpath("//body/div[@id='root']/div[1]/div[2]/div[2]/div[1]/div[2]/form[1]/div[2]/div[2]/button[1]/div[3]")).click();
        ...
        driver.findElement(By.xpath("//body[1]/div[9]/div[2]/div[2]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/a[1]")).click();
//        String buttonname =driver.findElement(By.xpath("//button[contains(text(),'Reschedule')]")).getText();
//        System.out.println(buttonname);
    }
    @And("Reschedule the booking list job and click cancel")
    public void rescheduleTheBookingListJobAndClickCancel() throws InterruptedException {
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("window.scrollBy(0,300)");
    ...
    public void logoutFromBuyerAndLoginAsSellerToCheckTheTransaction()throws InterruptedException {
         Actions action = new Actions(driver);
         WebElement element = driver.findElement(By.xpath("//p[contains(text(),'Buyer Individual')]"));
         action.moveToElement(element).build().perform();
         WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    ...
    @Then("Reschedule and cancel booking job")
    public void rescheduleAndCancelBookingJob() throws InterruptedException {
        Actions action = new Actions(driver);
        WebElement element = driver.findElement(By.xpath("//p[contains(text(),'Seller Business')]"));
        action.moveToElement(element).build().perform();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
