...
//        driver.findElement(By.id("password")).sendKeys("Work098765@#");
    ...
    public void enterAllTheMandatoryFieldAndClickSubmit() throws InterruptedException {
        ...
        driver.findElement(By.name("name")).sendKeys("vendorautoBm");
        driver.findElement(By.name("company_name")).sendKeys("oiiuuzz123BM");
        driver.findElement(By.name("email")).sendKeys("BMXdsfsdeuto1@gmail.com");
